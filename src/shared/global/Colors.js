export const TYPE_COLORS = {
  bug: "rgb(114, 159, 63)",
  dragon:
    "linear-gradient(180deg, rgb(83, 164, 207) 50%, rgb(241, 110, 87) 50%)",
  fairy: "rgb(253, 185, 233)",
  fire: "rgb(253, 125, 36)",
  ghost: "rgb(123, 98, 163)",
  ground:
    "linear-gradient(180deg, rgb(247, 222, 63) 50%, rgb(171, 152, 66) 50%)",
  ...
  flying:
    "linear-gradient(180deg, rgb(61, 199, 239) 50%, rgb(189, 185, 184) 50%)",
...
export const COLORS = {
  ...
  green: "rgb(77, 173, 91)",
  greenHover: "rgb(54, 145, 67)",
  blue: "rgb(48, 167, 215)",
  blueHover: "rgb(27, 130, 177)",
  orange: "rgb(238, 107, 47)",
  orangeHover: "rgb(218, 71, 27)",
};
